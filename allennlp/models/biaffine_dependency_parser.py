...
class BiaffineDependencyParser(Model):
    ...
    def forward(
        ...
        if Model.pred_prob:
            ...
            predicted_heads, predicted_head_tags, mask, arc_nll, tag_nll = parse_res
    ...
    def _parse(
        ...
        if self.training or not self.use_mst_decoding_for_validation:
            ...
            if Model.pred_prob:
                ...
                predicted_heads, predicted_head_tags = decoded
    ...
    def _run_mst_decoding(
        ...
        for energy, length in zip(batch_energy.detach().cpu(), lengths):
            ...
            # DEBUG: RETURN TOKEN HEAD PROBABILITES (ASSUME BATCH_SIZE=1)
            else:
                return scores.transpose(0,1)[1:]
